                ...
                if task.blocks_old:
                    ...
                    try:
                        ...
                        with transaction.atomic():
                            ...
                            self.stdout.write(self.style.SUCCESS(f"Successfully converted {len(blocks)} blocks for task {task.id}"))

                    except Exception as e:
                        self.stdout.write(self.style.ERROR(f"Something went wrong while converting task ({task.id}) blocks: {str(e)}"))
